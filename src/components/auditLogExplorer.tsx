...
function humanizeAction(action: string) {
  const labels: Record<string, string> = {
    ...
    ATTENDANCE_CORRECTION_REQUESTED: "근태 정정 신청",
    ATTENDANCE_CORRECTION_REQUEST_APPROVED: "근태 정정 승인",
    ATTENDANCE_CORRECTION_REQUEST_REJECTED: "근태 정정 반려",
    ATTENDANCE_CORRECTION_REQUEST_CANCELLED: "근태 정정 신청 취소",
    WORKPLACE_CREATED: "근무지 등록",
    WORKPLACE_UPDATED: "근무지 변경",
    WORKPLACE_DELETED: "근무지 삭제",
    ANNUAL_LEAVE_BALANCE_ADJUSTED: "연차 HR 보정",
