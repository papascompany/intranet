...
describe("PostgresHrRepository", () => {
  it("creates the employee and auth account atomically", async () => {
    ...
    await repository.createEmployeeWithAccount(
      ...
      {
        id: "account-0099", employeeId: "emp-0099", employeeNumber: "EMP-0099", loginId: "new-staff", passwordHash: "pbkdf2_sha256$310000$salt$hash", passwordChangedAt: "2026-07-14T00:00:00Z", passwordChangeRequired: true, sessionVersion: 1, failedSignInCount: 0
      }
    );
